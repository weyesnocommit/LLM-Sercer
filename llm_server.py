...
class TextProcessorServer:
    ...
    def gen_t5(self, model, tokenizer, config: dict, txt: str,):
        ...
        tokens = model.generate(
            ...
            top_p=config.get('top_p', None),  # Defaults to 1.0 (no filtering based on cumulative probability).
            top_k=config.get('top_k', None),  # Defaults to 50 (limits to top 50 tokens).
